...
```{r}
ggplot(data = sanitation_2000_2020,
...
The color of the bars is ordered from most dominant to lowest.

1.  What would you want to change?
2.  Why did we remove "safely managed sanitation services" from the data set in Task 3?
...
The code used only 2020 data with varname_short variables. The figures of the different variables of varname_short are separated and presented at national, urban and rural level.
