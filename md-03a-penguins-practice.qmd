...
There are eight (8) variables in the data set.

1.  How many observations are in the data set?

There are eight 344 observations in the data set.

1.  What data types are contained in the variables? (Reminder: <https://ds4owd-001.github.io/website/slides/lec-02-visualisation.html#/types-of-variables>)

The data includes discrete variables, continuous variables and categorical variables
